...
LOCK TABLES `sejur` WRITE;
/*!40000 ALTER TABLE `sejur` DISABLE KEYS */;
INSERT INTO `sejur` VALUES (1,'Bucuresti','Paris','2020-07-05','2020-07-12'),(2,'Bucuresti','Viena','2020-12-10','2020-12-15'),(3,'Bucuresti','Ankara','2020-12-11','2020-12-15'),(4,'Bucuresti','Berlin','2020-12-16','2020-12-20'),(5,'Bucuresti','Salzburg','2020-05-25','2020-06-02'),(6,'Cluj','Innsbruck','2020-06-01','2020-06-05');
/*!40000 ALTER TABLE `sejur` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `sezon` WRITE;
/*!40000 ALTER TABLE `sezon` DISABLE KEYS */;
INSERT INTO `sezon` VALUES (1,'Winter Holiday','2020-12-01','2021-01-15'),(2,'Sezon schi','2020-01-16','2020-02-28'),(3,'Primavara','2020-03-01','2020-04-01'),(4,'Vacanta de Paste','2020-04-02','2020-05-31'),(5,'Vara','2020-06-01','2020-07-20'),(6,'Concedii mare/munte vara','2020-07-21','2020-08-31'),(7,'Toamna','2020-09-01','2020-11-30');
/*!40000 ALTER TABLE `sezon` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `zbor` WRITE;
/*!40000 ALTER TABLE `zbor` DISABLE KEYS */;
INSERT INTO `zbor` VALUES (1,'Viena','2020-01-10','2020-01-10',5,7,2,200,2),(2,'Paris','2020-01-15','2020-01-15',9,11,3,500,1),(3,'Paris','2020-02-10','2020-02-10',17,21,2,560,3),(4,'Ankara','2020-02-11','2020-02-11',10,13,4,620,4),(5,'Berlin','2020-03-15','2020-03-15',12,14,2,350,5),(6,'Berlin','2020-03-16','2020-03-16',6,9,3,300,4);
/*!40000 ALTER TABLE `zbor` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-11-30 15:20:48
